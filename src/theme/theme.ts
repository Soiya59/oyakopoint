...
// 増やす目的。人数不足への対応ではない）。開発部/成果物/実装メモ.md 100章・
// デザイントークン.md 1.3節（2026-09-01改訂・2026-09-11改訂v1.18、決定1〜8）参照。
// この配列の値・順序は、DB側 next_member_avatar_color()（supabase/migrations/
// 20260920010000_expand_member_avatar_color_palette_15colors.sql、
// 2026-09-01版を打ち消す新規マイグレーション）の色配列と必ず一致させること
...
export const memberColorPalette = [
  ...
  { name: "アイスブルー", value: "#ADE6EB" }, // [2026-09-11追加]
  { name: "セルリアン", value: "#ADD3EB" }, // [2026-09-11追加]
  { name: "ペリウィンクル", value: "#B7B6ED" }, // [2026-09-11追加]
  { name: "オーキッド", value: "#DEB6ED" }, // [2026-09-11追加]
  { name: "ローズ", value: "#EDB6D3" }, // [2026-09-11追加]
] as const;
