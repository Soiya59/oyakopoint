    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.backdrop}>
        <Card style={styles.card} tone={tone}>
          ...
          {/* [2026-09-20削除・統括決定「それは削除だね」・やること.md 4-60①・
              主要画面ワイヤーフレーム.md 49.7章決定32撤回] 「おてつだい は ポイント。
              まいにちの おやくそく は シール。」の一言（2026-09-17追加・実装メモ239章）を
              削除した。シール帳の全面作り替え（要件定義書07-28章2026-09-19全面改訂・
              決定25）でクエストの種類分け（ポイント／台紙の2択）自体が無くなり、実態と
              合わなくなったため。過去の記録（実装メモ239章）は書き換えない。 */}
