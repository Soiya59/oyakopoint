...
export function FigureFrame({ size, ringColor, strokeWidth = 2, innerRatio = 0.62, children }: FigureFrameProps) {
  ...
  return (
    <View style={{ width: size, height: size, alignItems: "center", justifyContent: "center" }}>
      ...
      <View style={{ width: size * innerRatio, height: size * innerRatio, alignItems: "center", justifyContent: "center" }}>
        {children}
      </View>
    </View>
  );
